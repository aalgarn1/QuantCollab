...
//(function() {
  ...
  function onEndTurn(data){
    if(firstTurn){
      ...
      var interactiondynamicDATA = {
      activePlayer : activePlayer.name,
      objectLabel : data.drawingLabel,
      interactionDYNAMIC : data.coupled 
    }
      analyzer.addinteractionDATA(interactiondynamicDATA);
    ...
    turn.setCoupled(data.coupled); 
    turn.setDrawingLabel(data.drawingLabel);
    turn.setinteractionDYNAMIC(data.interactionDYNAMIC);
    console.log("Coupled: " + data.coupled + "Drawing lab veL: " + data.drawingLabel)

    var interactiondynamicDATA = {
      activePlayer : turn.activePlayer.name,
      objectLabel : turn.drawingLabel,
      interactionDYNAMIC : data.coupled
    }
    
    console.log("Interaction Dynamic data :" + interactiondynamicDATA);
